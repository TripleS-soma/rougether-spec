...
- **초기 재화**: 가입 시 지갑 발급 잔액 **코인 750·다이아 0**. 온보딩(튜토리얼)에서 가구 뽑기 단챠(코인 250) 1회를 소모시키고 500(단챠 2회분)을 남기는 값(멘토링 피드백 "처음 기본 재화 제공" 반영). → [shop/api.md](domains/shop/api.md) · [member/api.md](domains/member/api.md) 반영.
