...
도메인별 상세는 각 `domains/<도메인>/features.md`를 참조한다. 출처: [Notion 기능명세](https://www.notion.so/MVP-3782b260870e80988962cc129f651b6f).

재화: **코인**(루틴 실천 보상) / **다이아**(아이템 구매).
...
| AI 주간 회고 | 주간 집계, LLM 회고 생성 배치(GENERATED/FALLBACK), 회고 목록·상세 조회 | [domains/report/features.md](domains/report/features.md) |
