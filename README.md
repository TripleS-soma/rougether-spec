...
- **전체 ERD / 데이터 모델** → [erd.md](erd.md) · 출처 [ERDCloud](https://www.erdcloud.com/d/Qn9GqwdWnsqsiQQpi)
...
| 제품 지표 | [domains/analytics/](domains/analytics/) | 일별 활동, 리텐션, 북극성 지표, 개인/공동 참여군 비교 |

## 도메인 (MVP)

회원 · 루틴/투두 · 방(개인) · 뽑기 · 상점 · 집(공동) · 연속 출석 이벤트 · 제품 지표. 재화는 **코인**(루틴 실천·이벤트 보상)과 **다이아**(아이템 구매)로 구분.
