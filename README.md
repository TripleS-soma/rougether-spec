...
- **전체 ERD / 데이터 모델** (55 table) → [erd.md](erd.md) · 출처 [ERDCloud](https://www.erdcloud.com/d/Qn9GqwdWnsqsiQQpi)
...
| 미니게임 | [domains/minigame/](domains/minigame/) | 고양이 게임 3종, 입력 검증, 게임별 전체 회원 랭킹 |
